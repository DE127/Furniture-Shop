...
class CartController extends Controller
{
    ...
    public function checkout(Request $request){
        ...
        $order_data['name']=$request->user()->name;
        $order_data['first_name']=explode(' ',$request->user()->name)[0];
        $order_data['lat_name']=explode(' ',$request->user()->name)[1];
        $order_data['address1']=$request->user()->address1;
        $order_data['address2']=$request->user()->address2;
        $order_data['phone']=$request->user()->phone;
        $order_data['email']=$request->user()->email;
        return view('frontend.pages.checkout', compact('order_data'));
    }
}
